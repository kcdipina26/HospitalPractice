...
//        System.out.println(patient7);
        ...
        EmergencyPatient criticalPatient1 = new EmergencyPatient("John", 45, "A+", true, 245.6, "Medium", 103.10, "120 / 130", 5.60);
        ...
        System.out.println(criticalPatient1);  //magic of toString() method no need to manually try all fields it does it for you, show to text display
